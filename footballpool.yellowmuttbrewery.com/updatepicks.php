...
<title>YMB | Update My Picks</title>
...
<?php include 'pages/accountlinks.php';?>
	...
	<form method="post">
		...
		<input type="submit" id="showWeekPicks" name="showWeekPicks" value="Show My Picks"/> 
	</form>
	...
	if (isset ( $_POST ['showWeekPicks'] )) {
		...
		$week = $_POST ['week'];
		getUserPicksToUpdate ( $mysqli, $week, $userID );
	} else {
		echo 'Please select a week to update your picks!';
	}
	?>
</div>
</div>
